...
class UserController extends Controller
{
    ...
    public function update($id) {
        ...
        if ($user->save()) {
            ...
            if ($profile) {
                return redirect()->back()->with('success', 'User Profile Updated Success!');
            }
        }
    }
    ...
    public function store() {
        ...
        if ($user->save()) {
            ...
            if ($profile->save()) {
                return redirect()->back()->with('success', 'User Creadet Success');
            }
        }
    }
    ...
    public function editRole($role, $user_id) {
        ...
        if ($user) {
            return redirect()->back()->with('success', 'User Permission Change Success!');
        }
    }
}

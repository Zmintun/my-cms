        ...
        <div class="contact-section">
            ...
            <div class="contact-grids">
                ...
                <div class="col-md-4 contact-grid1">
                    ...
                    <ul>
                        <li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i> Office : 09-444161997</li>
                        <li><i class="glyphicon glyphicon-phone" aria-hidden="true"></i> Mobile : 09-960033115</li>
                        <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i> <a href="#"></a><a href="mailto:info@example.com">info@example.com</a></li>
                        <li><i class="glyphicon glyphicon-print" aria-hidden="true"></i> Fax : 09-444161997</li>
                    </ul>
                </div>
                <div class="clearfix"></div>
            </div>
